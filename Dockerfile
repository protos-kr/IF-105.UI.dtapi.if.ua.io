...
RUN yum update -y \
    ...
    && sed -i -e "s|https://dtapi.if.ua/api/|http://130.211.34.147/dt-api/|g" /home/Java/IF-105.UI.dtapi.if.ua.io/src/environments/environment.ts \
    && sed -i -e "s|https://dtapi.if.ua/api/|http://130.211.34.147/dt-api/|g" /home/Java/IF-105.UI.dtapi.if.ua.io/src/environments/environment.prod.ts \
