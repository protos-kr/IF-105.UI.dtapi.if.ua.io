...
RUN yum update -y \
    ...
    && sed -i -e "s|https://dtapi.if.ua/api/|http://34.91.124.112/dt-api/|g" /home/Java/IF-105.UI.dtapi.if.ua.io/src/environments/environment.ts \
    && sed -i -e "s|https://dtapi.if.ua/api/|http://34.91.124.112/dt-api/|g" /home/Java/IF-105.UI.dtapi.if.ua.io/src/environments/environment.prod.ts \
